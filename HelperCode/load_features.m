...
labels_train = dataset('file','../Train/train_labels.csv','Delimiter',',');
...
FNC_train = dataset('file','../Train/train_FNC.csv','Delimiter',',');
...
FNC_test = dataset('file','../Test/test_FNC.csv','Delimiter',',');
...
SBM_train = dataset('file','../Train/train_SBM.csv','Delimiter',',');
...
SBM_test = dataset('file','../Test/test_SBM.csv','Delimiter',',');
