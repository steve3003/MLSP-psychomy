...
labels_train$Class = factor(labels_train$Class)
...
data = merge(FNC_train, SBM_train, by="Id")
data = merge(data, labels_train, by="Id")
data$Id = NULL
nAttributes = dim(data)[2]

classifier = naiveBayes(data[,-nAttributes], data[,nAttributes]) 
